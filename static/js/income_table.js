            ...
            },
            {
                ...
                formatter: function (cell) {
                    ...
                    if (isOwner) {
                        ...
                        buttons += `<form method="post" action="/income/delete/${sanitizedId}/" class="inline-flex"><input type="hidden" name="csrfmiddlewaretoken" value="${escapedToken}"><button type="submit" class="${base} ${deleteClass}" title="Удалить" aria-label="Удалить" onclick="return confirm(&quot;${escapedConfirm}&quot;);">${deleteIcon}</button></form>`;
                        buttons += `</span>`;
                    } else {
