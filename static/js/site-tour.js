            ...
            finance_account: [
                ...
                },
                {
                    ...
                    popover: {
                        ...
                        description: 'Здесь отображается текущий баланс вашей группы счетов и динамика изменения баланса.<br><br>• <strong>Текущий баланс</strong> - общая сумма всех счетов<br>• <strong>Период (7 и 30 дней, 12 месяцев)</strong> - переключение периода анализа<br>• <strong>Изменение в ₽</strong> - абсолютное изменение за период<br>• <strong>Процент (%)</strong> - процентное изменение за период<br>• <strong>График</strong> - визуализация динамики баланса с цветовой кодировкой (зеленый - рост, красный - падение)',
                        side: 'bottom',
                        align: 'start'
                    }
                },
