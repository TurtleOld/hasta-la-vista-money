...
function initExpensePage() {
    ...
    function createEmptyPlaceholder() {
        ...
        iconPath.setAttribute('d', 'M12 8c-1.657 0-3 1.343-3 3 0 1.657 1.343 3 3 3 1.657 0 3-1.343 3-3 0-1.657-1.343-3-3-3Zm8 4a8 8 0 11-16 0 8 8 0 0116 0Z');
        ...
        descDiv.textContent = 'Добавьте первый расход, чтобы увидеть таблицу';
        ...
        link.textContent = 'Добавить расход';
            ...
            { title: 'Действия',
                formatter: function (cell) {
                    ...
                    if (isOwner) {
                        ...
                        const escapedConfirm = escapeHtml('Вы уверены, что хотите удалить этот расход?').replace(/"/g, '&quot;');
