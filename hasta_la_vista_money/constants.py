...
RECEIPT_ATTENTION_REASON_TOTAL_MISMATCH: Final = _(
...
ERROR_MODEL_UNAVAILABLE: Final = _(
    ...
    'Проверьте настройки RECEIPT_INFERENCE_URL.',
)
...
SUCCESS_MESSAGE_UPDATE_SELLER: Final = _(
    'Данные продавца успешно обновлены!',
)
...
STATEMENT_RECONCILIATION_PAGE_SIZE: Final = 25
STATEMENT_RETENTION_DAYS: Final = 30
...
TODAY: Final = datetime.now(tz=UTC).date()
CURRENT_YEAR: Final = datetime.now(tz=UTC).year
