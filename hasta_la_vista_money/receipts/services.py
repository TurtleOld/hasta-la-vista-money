        ...
        messages=[
            {
                ...
                'content': (
                    ...
                    'изображение и вернуть JSON без дополнительного текста. '
                    'Извлекайте все артикулы из чека, даже если их названия '
                    'повторяются или похожи. Каждый артикул должен быть '
                    'добавлен в список items как отдельный элемент. '
                ...
                'content': [
                    {
                        ...
                        'text': (
                            ...
                            'Преобразуйте его в JSON со следующими ключами:  '
                            ...
                            '- **operation_type**: тип операции(1 для "Приход",'
                            '2 для "Расход").  '
                            '- **receipt_date**: дата и время в формате '
                            '"ДД.ММ.ГГГГ ЧЧ:ММ", например: "20.05.2025 11:40".'
                            '- **number_receipt**: номер ФД из чека '
                            '(числовое значение).  '
                            '- **nds10**: сумма НДС 10%, если указано, или 0.  '
                            '- **nds20**: сумма НДС 20%, если указано, или 0.  '
                            '- **items**: список товаров, где каждый товар '
                            'содержит:  '
                            ...
                            '  - **amount**: общая сумма за товар '
                            '(цена × количество). Нельзя пропускать товары '
                            'с чека или с нулевой ценой. '
                            'Ответьте только в виде корректного JSON, '
                            'без дополнительного текста. Учитывайте указания, '
                    ...
                    },
                    {
                        'type': 'text',
                        'text': (
                            'Обратите внимание: в чеке могут встречаться '
                            'повторяющиеся товары с одинаковыми названиями. '
                            'Каждый такой товар должен быть добавлен в список '
                            'items как отдельный элемент. Например, если товар '
                            '"Хлеб" встречается несколько раз, каждый раз он '
                    ...
                    },
                    {
                        ...
                        'text': (
                            ...
                            '"price": 25.00, "quantity": 2, "amount": 50.00},\n'
                            '  {"product_name": "Хлеб пшеничный", '
                            '"category": "Хлебобулочные изделия", '
                            '"price": 25.00, "quantity": 1, "amount": 25.00},\n'
                            '  {"product_name": "Молоко 3%", "price": 45.00, '
                            '"quantity": 1, "amount": 45.00}\n'
                            ']\n'
                            '\n'
                            'Каждая строка товара должна быть отдельным '
                            'объектом в массиве items, даже если названия '
                            'совпадают.'
                        ),
                    },
                    {
