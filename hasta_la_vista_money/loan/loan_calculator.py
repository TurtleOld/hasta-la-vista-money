def calculate_annuity_schedule(
    ...
    """
    Возвращает график платежей для аннуитетного кредита
    с банковским округлением (до рубля).
    ...
    :return: dict с ключами:
        - 'schedule': список платежей (dict: месяц, платёж, проценты,
...
def calculate_differentiated_schedule(
    ...
    """
    Возвращает график платежей для дифференцированного кредита
    с банковским округлением (до рубля).
    :param amount: сумма кредита
    :param annual_rate: годовая ставка в процентах (например, 12)
    :param months: срок кредита в месяцах
