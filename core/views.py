...
This module provides reusable base classes for FilterView, CreateView, and UpdateView
to reduce code duplication and ensure consistent behavior across different entities.
"""
...
class BaseEntityCreateView(
    LoginRequiredMixin,
    SuccessMessageMixin[Any],
    CreateView[ModelType, FormType],
    Generic[ModelType, FormType],
):
